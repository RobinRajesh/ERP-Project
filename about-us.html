  ...
  <div class="container-fluid text-white" id="change-color">
    <div class="row" id="top-containt">
      ...
      <div class="col-8 pt-4 mt-1 text-center">
        ...
        <ul class="dropdown-menu mt-4 text-center" style="margin-left:-6%;border-radius:10px;">
          ...
          <li class="pre-profile-1 pt-2 pb-2"><a href="login-form.html" class="color" style="font-weight:600">Log In</a>
          </li>
        </ul>
        ...
        <span class="menu"><a href="#/" class="color">about</a></span>
    ...
    <div class="container-fluid side-bar px-0">
      ...
      <ul class="pt-5 pre-side-bar">
        ...
        <li class="pt-3" style="margin-left:-5%"><a href="login-form.html" class="color">Log In</a><span><a href="#"
              class="color"><img src="log-in..png" class="log-in"></a></span></li>
      </ul>
    </div>
  </div>
  <!--header part end-->
  ...
  <div class="container mt-5">
    ...
    <div class="row mt-5">
      ...
      <div class="col-xl-6 col-lg-6 col-sm-12 pt-5" style="font-weight: 600;">
        At [Your Tech E-commerce Website Name], we are dedicated to bringing you the latest and most innovative tech
        products from around the world. Our passion for technology and commitment to customer satisfaction drive us to
        provide an unparalleled shopping experience for tech enthusiasts like you.<span class="card-3"> Our mission is
          simple yet ambitious: to be the go-to destination for all your tech needs. We aim to offer a carefully curated
          selection of cutting-edge gadgets, electronics, and accessories, all while providing exceptional customer
      ...
      <div class="row ">
        ...
        <div class="col-xl-3 pt-5 hide-girl">
          <span style="font-size:20px;text-transform: uppercase;font-weight: 800;"
            data-aos="zoom-in-left">products</span><br>
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12 footer  pt-5">
          <span style="font-size:20px;text-transform: uppercase;font-weight: 800;" class="text-center"
            data-aos="zoom-in-left">useful link</span><br>
        ...
        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-12 col-12 footer pt-5 pb-3">
          ...
          <p data-aos="fade-up"><i class="fa fa-home" aria-hidden="true" style="font-size:20px;"></i>&nbsp; New York,
            10012,</p>
